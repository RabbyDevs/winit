        ...
        self.thread_executor.execute_in_thread(move || {
            {
                ...
                if !guard.dragging {
                    ...
                    // we shouldnt even have this ever be true when dragging is being triggered! as for the mouse to trigger it again, itd need to leave the dragging state.
